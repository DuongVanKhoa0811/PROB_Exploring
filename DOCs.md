WANDB_NAME=PROB_MOWODB_V1: 2GPUs, BS 2, lr_drop 40 Done Train results is not good.
WANDB_NAME=PROB_MOWODB_V2: 1GPUs, BS 4, lr_drop 40 Break Train results is not good.
Queue Cluster, remember to push the wandb offline
WANDB_NAME=PROB_MOWODB_V3: 2GPUs, BS 4, lr_drop 35 Running
